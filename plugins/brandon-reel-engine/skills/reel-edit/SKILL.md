...
Never mix background music into Brandon short-form exports. Set `audio_policy.music_required:false` and omit `music`; Brandon adds music on the platform. Animate every on-screen text, card, label and illustration and choose purposeful visual transitions at meaningful cut or section boundaries. Do not render production disclaimers in the picture. Add effects where they help a reveal and listen at phone volume to preserve consonants. Do not reuse an old voice track or duplicate a full mixed reference soundtrack.
